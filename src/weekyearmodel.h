#ifndef WEEKYEARMODEL_H
#define WEEKYEARMODEL_H
...
class WeekYearModel : public QAbstractListModel
{
    Q_OBJECT
...
public:
    ...
    explicit WeekYearModel(DataContainer *data, QObject *parent = nullptr);
